...
defined('SMIS_DB_SCHEMA') or define('SMIS_DB_SCHEMA', 'smis');
defined('SMIS_DB_USER') or define('SMIS_DB_USER', 'smisdev');
defined('SMIS_DB_PASS') or define('SMIS_DB_PASS', 'SM1sAdmin23');
...
defined('SMIS_PORTAL_DB_SCHEMA') or define('SMIS_PORTAL_DB_SCHEMA', 'smisportal');
defined('SMIS_PORTAL_DB_USER') or define('SMIS_PORTAL_DB_USER', 'smisportal');
defined('SMIS_PORTAL_DB_PASS') or define('SMIS_PORTAL_DB_PASS', 'P0rt@ladmin23');