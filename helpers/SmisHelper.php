...
//                }
    ...
    {
        $breadcrumb = '<div class="content-header"><div class="page-header"><h6>';
        $breadcrumb .= ' <a href="' . Yii::$app->homeUrl . '" class="btn-link">Home</a>';
        $breadcrumb .= ' <i class="fa fa-angle-right" aria-hidden="true"></i> ';
        foreach ($urls as $key => $url){
            if(empty($url)){
                $breadcrumb .= $key;
            }else{
                $breadcrumb .= ' <a href="' . $url . '" class="btn-link">' . $key . '</a>';
                $breadcrumb .= ' <i class="fa fa-angle-right" aria-hidden="true"></i> ';
            }
        }
