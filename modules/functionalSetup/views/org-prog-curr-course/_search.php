...
?>
    ...
    <div class="row mb-2">
        <div class="form-group">
            <div class="d-flex justify-content-between">
                <?= Html::a('  Reset Page', ['/functionalSetup/org-prog-curr-course/index'], ['class' => 'bi bi-arrow-clockwise btn btn-outline-secondary']); ?>
    ...
    <?php if (null !== Yii::$app->request->get('OrgProgCurrCourseSearch')) : ?>
        <div class="row mb-2">
            <div class="form-group">
                <div class="d-flex justify-content-between">
                    <?= Html::a('  Add Courses', ['/functionalSetup/org-prog-curr-course/add-courses', 'prog_curriculum_id' => Yii::$app->request->get('OrgProgCurrCourseSearch')['prog_curriculum_id']], ['class' => 'bi bi-plus btn btn-outline-success']); ?>
                </div>
            </div>
        </div>
    <?php endif; ?>
