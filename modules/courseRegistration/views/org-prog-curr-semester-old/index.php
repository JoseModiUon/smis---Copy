    ...
    [
        ...
        'buttons' => [
            'update' => function ($url, $model, $key) {
                return  Html::a(' Update', ['/courseRegistration/org-prog-curr-semester/update','prog_curriculum_semester_id' => $model->prog_curriculum_semester_id], ['class' => ' bi bi-pencil-square btn btn-outline-primary btn-sm']);
            },
        ]
