...
<div class="org-prog-curr-course-form">
        ...
        <div class="col-md-12">
            ...
            echo $form
                ...
                ->widget(Select2::classname(), [
                    'data' => $data,
                    'language' => 'en',
                    'options' => ['placeholder' => 'Select Programme Curriculum ...', 'disabled' => $update ?? true],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ]);
        ...
        <div class="col-md-12">
            ...
            echo $form
                ...
                ->widget(Select2::classname(), [
                    'data' => $data,
                    'language' => 'en',
                    'options' => ['placeholder' => 'Select Course ...', 'disabled' => $update ?? true],
                    'pluginOptions' => [
                        'allowClear' => true
                    ],
                ]);
    ...
    <div class="row mb-2">
        <div class="col-md-12">
            <?php
            $academicLevels = OrgAcademicLevels::find()->select(['academic_level', 'academic_level_name'])->orderBy([
                'academic_level' => SORT_ASC,
            ])->all();
            $data = ArrayHelper::map($academicLevels, 'academic_level', 'academic_level_name');
            echo $form
    ...
    <div class="row mb-2">
        <div class="col-md-12">
            <?php
            $sems = OrgSemesterCode::find()
                ->select([
                    'semester_code as semester',
                    'semster_name'
                ])
                ->where('true')->asArray()->all();
            $data = ArrayHelper::map($sems, 'semester', 'semster_name');

            echo $form
                ->field($model, 'semester')
