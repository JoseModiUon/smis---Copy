    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post())) {
                ...
                $org = OrgUnitHistory::find()->where(['org_unit_id' => $model->org_unit_id])
                    ->andWhere(['org_type_id' => $model->org_type_id])
                ...
                if (!$org) {
                    if (!$model->save()) {
                        Yii::$app->getSession()->setFlash('', [
                            ...
                            'message' => 'Could not add to organisation history. Please try again.',
                            'closeButton' => null,
                        ]);
                    }
                    Yii::$app->getSession()->setFlash('', [
                        ...
                        'message' => "Organisation history added successfully",
                        'closeButton' => null,
                    ]);
                    ...
                    Yii::$app->getSession()->setFlash('', [
                        ...
                        'message' => 'Organisation History already set for specified unit, type and parent. Please provide unique set of values.',
                        'closeButton' => null,
                    ]);
                    return $this->redirect(['index']);
                }
