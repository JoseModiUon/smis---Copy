...
<div class="sponsor-beneficiary-view">
    ...
    <p>
        <?php Html::a('Update', ['update', 'sponsor_beneficiary_id' => $model->sponsor_beneficiary_id], ['class' => 'btn btn-primary']) ?>
        <?php Html::a('Delete', ['delete', 'sponsor_beneficiary_id' => $model->sponsor_beneficiary_id], [
