...
//        'https://cdn.jsdelivr.net/npm/admin-lte@3.2/dist/css/adminlte.min.css',
        ...
        // Select2
        'studentreg/adminlte/plugins/select2/css/select2.min.css',
        'studentreg/adminlte/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css',
    ...
    public $js = [
        ...
        // Select 2
        'studentreg/adminlte/plugins/select2/js/select2.full.min.js',
