...
class SPAdmittedStudent extends ActiveRecord
{
    ...
    public function rules(): array
    {
        return [
            ...
            [['adm_refno', 'source_id', 'application_refno', 'intake_code', 'student_category_id', 'sponsor', 'study_centre_group_id', 'reg_no_serial_no'], 'default', 'value' => null],
            [['adm_refno', 'source_id', 'application_refno', 'intake_code', 'student_category_id', 'sponsor', 'study_centre_group_id', 'reg_no_serial_no'], 'integer'],
            ...
            [['kcse_index_no', 'primary_phone_no', 'alternative_phone_no', 'post_code', 'post_address', 'kuccps_prog_code', 'uon_prog_code', 'national_id', 'birth_cert_no', 'passport_no', 'service', 'userid'], 'string', 'max' => 20],
            [['kcse_year'], 'string', 'max' => 10],
            [['primary_email', 'alternative_email', 'surname', 'nationality', 'ip_address'], 'string', 'max' => 50],
