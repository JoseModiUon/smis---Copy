...
$this->params['breadcrumbs'][] = ['label' => 'Provisional Transcript', 'url' => ['full-provisional-transcript']];
...
<div class="org-prog-curr-course-index">
    <div class="card">
        <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="col-md-12">
                    <?php echo  $this->render('_search_transcript_full', ['model' => $searchModel]) ?>
                </div>
            </div>
            <hr>
            <?= GridView::widget([
                        ...
                        'buttons' => [
                            'update' => function ($url, $model, $key) {
                                return  Html::a(' View Transcript ', [
                                    '/exam-management/reports/view-full-provisional-transcript',
