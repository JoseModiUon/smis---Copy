...
/** @var app\modules\examManagement\models\search\MarksEntryListController $searchModel */
                ...
                $buttons = [
                    ...
                    'buttons' => [
                        'update' => function ($url, $model, $key){
                            return  Html::a('<i class="fa fa-eye" aria-hidden="true"></i> marks list',  
                                [
                                    '/exam-management/marks-entry-list/view',
