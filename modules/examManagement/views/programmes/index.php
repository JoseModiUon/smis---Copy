...
<hr>
    <div class="row justify-content-md-center">
		...
		<div class="clearfix">&nbsp;</div>
		<font color='red' >Select the options provided below and click "View Curriculums" button to list Curriculums</font>
...
$programme = OrgProgrammes::find()
    ->select(['prog_code', 'prog_full_name','concat(prog_code,\' - \',prog_full_name) as prog_dtl' ])->orderBy(['prog_code' => SORT_ASC])->asArray()->all();
...
if($prog_code == 0 && !empty($_REQUEST)) {
  ...
  <?php
   ...
   echo  '<div class="col">';
echo Html::submitButton('<i class="fa-solid fa-magnifying-glass"></i> View Curriculums', ['class' => 'submit btn btn-success btn-lg', 'style' => 'margin-top:20px']) ;
echo '</div><p/> <hr>';
                ...
                [
                 ...
                 [
                    ...
                    'value' => function ($model) {
                        ...
                        //return '';
                        return Html::a('View Curriculum Requirements', ['/exam-management/programmes/programme-requirements', 'prog_code' => $_REQUEST['prog_code'],'prog_curriculum_id' => $model['prog_curriculum_id']], ['class' => 'btn btn-outline-success btn-sm']);
                    }
                ],
                //'prog_full_name',
