    ...
    [
        ...
        'buttons' => [
            'update' => function ($url, $model, $key) {
                return  Html::a(' Update', ['/examinationManagement/prog-curr-level-requirement/update','prog_curr_level_req_id' => $model['prog_curr_level_req_id']], ['class' => ' bi bi-pencil-square btn btn-outline-primary btn-sm']);
            },
        ]
