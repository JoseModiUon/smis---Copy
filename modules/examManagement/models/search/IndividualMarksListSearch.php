...
/**
 * IndividualMarksListSearch represents the model behind the search form of `app\modules\courseRegistration\models\CrProgCurrTimetable`.
 */
class IndividualMarksListSearch extends CrProgCurrTimetable
{
