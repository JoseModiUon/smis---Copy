...
class Student extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['student_number', 'surname', 'other_names', 'gender', 'country_code', 'date_of_birth'], 'required'],
            [['date_of_birth', 'registration_date'], 'safe'],
    ...
    {
        return $this->hasMany(SmExamResult::class, ['fk_registration_number' => 'student_number']);
    }
    ...
    {
        return StudentProgrammeCurriculum::find()->where(['student_id' => $this->student_id])->one()->getStudentCategory();
    }
}
