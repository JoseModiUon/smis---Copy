...
class ReceiptSponsorFund extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['sponsor_id', 'amount', 'trans_type', 'receipt_date', 'user_id', 'post_date', 'no_of_beneficiaries'], 'required'],
    ...
    public function findBalance() :int {
        ...
        $total_amount = array_reduce($beneficiaries,fn($sum, $item) => $sum += $item->amount,0);
